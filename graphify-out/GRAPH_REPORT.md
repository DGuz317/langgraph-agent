...
## Corpus Check
- 96 files · ~22,504 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 821 nodes · 1169 edges · 84 communities (72 shown, 12 thin omitted)
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 278 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4c2913e6`
...
Cohesion: 0.10
Nodes (15): get_llm(), _user_input_must_not_be_blank(), _has_arg_value(), _instruction_must_not_be_blank(), _validate_agent_intent_and_required_fields(), _validate_output_consistency(), PlannerAgent, FailingPlannerAgent (+7 more)
...
Cohesion: 0.15
Nodes (18): AggregatorAgent, AgentResult, AggregatorInput, AggregatorOutput, BaseModel, PlannerInvokeRequest, API request for invoking or resuming the planner., final_response_node() (+10 more)
...
Cohesion: 0.08
Nodes (27): acontext_session_id(), AcontextCapture, build_acontext_capture(), _ensure_session(), PlannerInteractionCapture, Map existing planner thread identifiers into stable Acontext UUIDs., Store one planner interaction., Capture user-visible planner turns in Acontext. (+19 more)
...
- **Why does `build_async_checkpointer_context()` connect `Community 18` to `Community 9`, `Community 4`?**
...
- **Are the 16 inferred relationships involving `PlannerServiceResponse` (e.g. with `FakePlannerService` and `FakeSessions`) actually correct?**
